...
# Usage:
# From the admin user, run the following command in Terminal:
# sudo python -c "$(curl -fsSL http://cas.unt.edu/go/InstallSalt)"

# credit: lifted most of this script from Hannes Juutilainen <hjuutilainen@mac.com>
